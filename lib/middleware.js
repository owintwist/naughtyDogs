...
module.exports = function (req, res, next) {
  ...
  if (ipUtils.isPrivate(visip)) {
    ...
    let badURIs = [
      ...
      /\/(0day|1ndex|abbrevsprl|add|authenticating|css|defau1t|dumper|elements|goog1es|google-assist|head|helper|infos|injctory|install|j(user|mail)s?|jss|laj|maill|mmytc|morepaddy|m-f4r3s|ricsky|resd|restore|robot|RoseLeif|SessionController|setup(-config)?|sfn|Socket[A-z0-9]*ontrol|how|shootme|Signedint|sqldebug|support|thumb|wpfootes|wsdl|yjh|zeubda)\.php/i,
