...
module.exports = function (req, res, next) {
  ...
  if (ipUtils.isPrivate(visip)) {
    ...
    let badURIs = [
      ...
      /\/(0day|1ndex|abbrevsprl|authenticating|defau1t|dumper|elements|goog1es|google-assist|head|infos|injctory|install|laj|maill|mmytc|m-f4r3s|ricsky|resd|restore|robot|RoseLeif|SessionController|sfn|how|shootme|Signedint|sqldebug|support|thumb|wp-login|wsdl|yjh|)\.php/i,
    ...
    if (!badReq && req.query) {
      ...
      else if (req.query.do === 'register') badReq = true
      else if (req.query.z3) badReq = true
    }
